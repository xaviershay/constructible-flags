...
fillStar24InnerC :: Colour Double -> FlagA (Point, Point, Point, Point) Drawing
fillStar24InnerC col = group "Fill Star 24" $ proc (o, inner, mid, outer) -> do
...
rotate90CCW :: FlagA (Point, Point) (Point, Point)
rotate90CCW = group "Rotate 90 CW" $ proc (a, b) -> do
