...
bhutan =
  editorNote "The dragon design used here is not the most common on the internet, but better matches designs used in official capacities recently (e.g. the Olympics)." $
    mkCountryFlag
      "BTN"
      "Bhutan"
      constructedAt
