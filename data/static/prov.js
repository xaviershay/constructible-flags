    ...
    fetch(path)
        ...
        .then((data) => {
            ...
            for (const r of Object.values(data.wasInfluencedBy || {})) {
                const ee = r["prov:influencee"],
                    er = r["prov:influencer"];
...
function renderProv(nodes, links) {
    ...
    const link = g
        ...
        .attr("stroke-dasharray", (d) =>
            d.rel === "wasInfluencedBy" ? "5,3" : null,
        )
